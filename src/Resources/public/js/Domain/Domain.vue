    ...
    export default {
        ...
        data() {
            return {
                ...
                apiUrlClass: window.location.origin+'/evrinoma/api/exim/domain/class',
                domainClass: null,
                serverClass: null,
                apiUrlDomainClass: window.location.origin+'/evrinoma/api/exim/domain/class',
                apiUrlServerClass: window.location.origin+'/evrinoma/api/exim/server/class',
            }
        },
        mounted() {
            this.doMount();
